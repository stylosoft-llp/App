  ...
  <v-layout column align-center justify-center fill-height>
    <v-card max-width="600" width="100%">
      <v-card-text>
        ...
        <v-combobox outlined v-model="product.category" :search-input.sync="cat_search" :items="cats" label="Product Category" />
        <v-text-field
          outlined
        ...
        <v-row>
          ...
          <v-col>
            ...
            <div v-if="product.replacement">
              ...
              <div v-else>
                <v-btn
                  color="secondary"
                  :to="`/app/products/form?type=replacement&pid=${product.id}`"
                >
                  Add/Edit Form</v-btn
                >
              </div>
          ...
          <v-col>
            <v-checkbox
              ...
              :true-value="1"
              :false-value="0"
              v-model="product.repair"
              label="Repair"
            />
            <div v-if="product.repair">
              <div v-if="product.repair_form">
                <v-btn
                  color="secondary"
                  @click="addForm('repair')"
                >
                  Edit Form</v-btn
                >
                <v-btn color="error">Delete</v-btn>
              ...
              <div v-else>
                <v-btn
                  color="secondary"
                  :to="`/app/products/form?type=repair&pid=${product.id}`"
                >
                  Add/Edit Form</v-btn
                >
              </div>
