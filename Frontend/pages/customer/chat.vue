<template>
	<v-layout row container>
		...
		<v-col cols="12" md="9">
			...
			<div v-else>Select Conversation From The Left Pane. If Conversation is unavailable, Contact the service engineer or administrator to start in-app conversation.</div>
		</v-col>
	</v-layout>
</template>
